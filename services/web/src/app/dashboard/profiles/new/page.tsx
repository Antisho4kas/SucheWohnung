...
import { Save, ArrowLeft, MapPin, Euro, Maximize, BedDouble, Check } from "lucide-react";
  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">{t("dashboard.profiles.create")}</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button type="submit" disabled={loading} className="btn btn-primary flex-1">
            <Save size={18} /> {loading ? t("profile.submitting") : t("profile.submit")}
          </button>
        </div>
      </form>
    </div>
